...
/**
 * Finnish Cybersecurity MCP — stdio entry point.
 *
 * Provides MCP tools for querying NCSC-FI (Kyberturvallisuuskeskus —
 * National Cyber Security Centre Finland) guidelines, technical reports,
 * security advisories, and cybersecurity frameworks.
 *
 * Tool prefix: fi_cyber_
 */
...
const SERVER_NAME = "finnish-cybersecurity-mcp";
...
const TOOLS = [
  ...
  },
  {
    ...
    inputSchema: {
      ...
      properties: {
        reference: {
          type: "string",
          description: "NCSC-FI document reference",
        },
      },
      required: ["reference"],
    },
  ...
  },
  {
    ...
    description:
      "Get a specific NCSC-FI security advisory by reference (e.g., 'NCSC-FI-2024-001').",
    inputSchema: {
      type: "object" as const,
      properties: {
        reference: {
          type: "string",
          description: "NCSC-FI advisory reference",
        },
      },
      required: ["reference"],
    },
    ...
    switch (name) {
      ...
      case "fi_cyber_about": {
        return textContent({
          ...
          version: pkgVersion,
          description:
            "NCSC-FI (Kyberturvallisuuskeskus — National Cyber Security Centre Finland) MCP server. Provides access to Finnish national cybersecurity guidelines, technical reports, sector-specific guidance, NIS2 implementation materials, and security advisories.",
